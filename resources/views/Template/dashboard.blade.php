...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary">
    ...
    <a href="../../index3.html" class="brand-link d-flex align-items-center">
      <img src="{{asset('source/logoperpus.png')}}" alt="Perpus Logo" class="brand-image img-circle" style="opacity: .8">
      <span class="brand-text font-weight-light">Hope Library</span>
    </a>
